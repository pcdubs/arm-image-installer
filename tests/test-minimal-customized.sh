#!/bin/bash
# Test: Minimal image with full customization
# Create a custom Minimal image with resize, SSH key, and other options
...
echo "======================================================"
echo "= Test: Minimal Image - Full Customization"
echo "= Started: $(date)"
echo "======================================================"
...
OUTPUT_IMAGE="${TEST_OUTPUT_DIR}/test-minimal-customized.img"
rm -f "$OUTPUT_IMAGE"
...
echo "======================================================"
echo "= ✓ Test PASSED: Minimal Customized"
